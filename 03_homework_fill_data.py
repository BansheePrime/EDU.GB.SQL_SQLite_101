...
with open("data_sources/02_homework_teachers.csv", "r") as teachers_data:
...
with open("data_sources/02_homework_courses.csv", "r") as courses_data:
...
with open("data_sources/02_homework_streams.csv", "r") as streams_data:
...
with open("data_sources/02_homework_grades.csv", "r") as grades_data:
